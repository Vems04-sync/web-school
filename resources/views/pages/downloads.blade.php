<x-app-layout>
    <div class="bg-blue-900 py-16 text-white text-center">
        ...
        <p class="text-blue-100 max-w-2xl mx-auto">Pusat unduhan dokumen resmi, brosur, dan materi pembelajaran MTsN Nusantara.</p>
    </div>
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <svg class="w-5 h-5 text-blue-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" /></svg>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <a href="{{ $doc->file_path }}" target="_blank" class="inline-flex items-center px-3 py-1.5 border border-blue-600 text-xs font-bold rounded text-blue-700 bg-white hover:bg-blue-50 transition">
