<x-app-layout>
    ...
    <div class="relative overflow-hidden bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-700 pt-36 pb-20 text-white text-center">
        ...
        <div class="relative z-10 max-w-4xl mx-auto px-4">
            ...
            <h1 class="text-4xl md:text-5xl font-black mb-4 tracking-tight">Berita & Kegiatan Sekolah</h1>
            <p class="text-emerald-100 max-w-2xl mx-auto text-base sm:text-lg leading-relaxed">Ikuti perkembangan terbaru, aktivitas harian, dan prestasi gemilang civitas akademika SMA AL-ISLAMI.</p>
        </div>
    </div>
